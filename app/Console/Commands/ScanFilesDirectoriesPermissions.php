...
class ParsePermissions extends Command
{
     ...
     * @var string
     */
    protected $signature = 'scan:directories';
     ...
     * @var string
     */
    protected $description = 'Parse all files to assign default permissions and extract them to database if they not exists';
