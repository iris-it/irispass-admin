                            ...
                            @foreach($roles as $role)
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="{{action('Admin\RoleController@destroy',['id' => $role->id])}}" class="btn btn-flat btn-danger" data-method="DELETE" data-toggle="tooltip" title="{{trans('role:delete-action')}}" data-token="{{csrf_token()}}" data-confirm="{{trans('app.role.delete-action-warning')}}"><i class="fa fa-trash"></i></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
